...
export default function Footer() {
  return (
    <footer>
      ...
      <div><h4>Encontranos</h4><p><MapPin size={15}/> Av. Ejemplo 4521</p><p><Clock3 size={15}/> Lun-Sab · 10h a 22h</p><a href="https://www.instagram.com/" target="_blank"><Instagram size={15}/> @monstergym</a>
      <a
        target="_blank"
        rel="noreferrer"
